...
-- Date: Sun, 11 Jun 2017 20:39:38 +0000
...
SET autocommit=0;
INSERT INTO `auth_assignment` VALUES ('admin','1',1497211512);
...
SET autocommit=0;
INSERT INTO `auth_item` VALUES ('admin',1,'Usuario Administrador',NULL,NULL,1497211478,1497213330),('Cursos - Actualizar',2,'El usuario puede actualizar cursos',NULL,NULL,1497213211,1497213211),('Cursos - Crear',2,'El usuario puede crear cursos',NULL,NULL,1497211541,1497213133),('Cursos - Eliminar',2,'El usuario puede eliminar cursos',NULL,NULL,1497213157,1497213157),('Cursos - Leer',2,'El usuario puede consultar cursos',NULL,NULL,1497213190,1497213190),('Cursos - Todos',2,'El usuario puede realizar todas las acciones con los cursos',NULL,NULL,1497213271,1497213298);
...
SET autocommit=0;
INSERT INTO `auth_item_child` VALUES ('Cursos - Todos','Cursos - Actualizar'),('Cursos - Todos','Cursos - Crear'),('Cursos - Todos','Cursos - Eliminar'),('Cursos - Todos','Cursos - Leer'),('admin','Cursos - Todos');
...
SET autocommit=0;
INSERT INTO `backups` VALUES (1,'/home/criera/Projects/ceneac_yii/backups/dump2017-03-19-21:02:01.sql',NULL,NULL),(2,'/home/criera/Projects/ceneac_yii/backups/dump2017-04-02-17:16:15.sql',NULL,NULL),(3,'/home/criera/Projects/ceneac_yii/backups/dump2017-04-09-15:32:38.sql',NULL,NULL);
...
CREATE TABLE `registers` (
  ...
  `personal_bill` tinyint(1) NOT NULL,
  `comments` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on: Sun, 11 Jun 2017 20:39:38 +0000
