 ...
 * @var app\models\InterestListSearch $searchModel
 */
$this->title = 'Interest Lists';
...
?>
<div class="giiant-crud interest-list-index">
    ...
    <div class="table-responsive">
        ...
        echo ExportMenu::widget([
		        ...
		        'fontAwesome' => true,
						...
						'filename' => 'CENEAC_ListaDeIteresados_'.getdate()['mday'].'-'.getdate()['mon'].'-'.getdate()['year'],
		    ]);
