...
?>
<div class="giiant-crud permission-index">
		...
		'dropdown' => [
			...
			'items' => [
				[
					...
					'label' => '<i class="glyphicon glyphicon-random text-muted"></i> ' . 'Permission Role',
				],
				[
					'url' => ['role/index'],
				...
				[
					'url' => ['user/index'],
					'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . 'User',
				],
